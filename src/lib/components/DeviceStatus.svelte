...
<div class="text-sm mb-4">
	<span class="opacity-70">Seadme ID:</span>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
	...
	<div class="overflow-x-auto">
		<div class="text-sm font-semibold opacity-70 mb-2">Küte</div>
		<table class="table table-zebra table-sm">
			<tbody>
				<tr>
					...
					<td>
						{#if state.power_on}
							<span class="badge badge-success badge-sm">SEES</span>
						{:else}
							<span class="badge badge-ghost badge-sm">VÄLJAS</span>
						{/if}
					</td>
				</tr>
				<tr>
	...
	{#if state.dhw_tank_temp !== undefined && state.dhw_tank_temp !== null}
		<div class="overflow-x-auto">
			<div class="text-sm font-semibold opacity-70 mb-2">Boiler (sooja vee)</div>
			<table class="table table-zebra table-sm">
				<tbody>
					<tr>
